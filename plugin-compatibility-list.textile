...
*Version tested:* v0.3
*Notes:* Help documentation needs h2 instead of h3, and h3 instead of h4.
...
*Notes:* Help documentation has inline styling that need to be removed by plugin author. Can use Textpattern standard classes and structure instead (i.e. @<code>@ and @<pre>@ tags, @class="highlight"@, etc).
