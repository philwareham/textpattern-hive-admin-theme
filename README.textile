...
If you want to remove the Textpattern logo branding and link from the header, simply delete line 25 of @hive.php@.

Within the @custom.css@ file you can choose between any of the supplied colour schemes, simply amend the URL in line ??? to whichever colour option you desire.
