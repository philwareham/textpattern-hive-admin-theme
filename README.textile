h1. Hive admin-side theme for Textpattern CMS v4.6
...
Supported browsers: Google Chrome 12+, Internet Explorer 8+, Mozilla Firefox 4+, Apple Safari 5+ and Opera 10+. Development environment requires <a href="http://sass-lang.com" rel="external" title="Go to the Sass website">Sass</a> 3.2+ and <a href="http://compass-style.org" rel="external" title="Go to the Compass website">Compass</a> 0.12.2+, plus the Compass extensions <a href="https://github.com/Team-Sass/breakpoint" rel="external" title="Go to the Breakpoint website">Breakpoint</a> 2.0+ and <a href="http://singularity.gs" rel="external" title="Go to the Singularity website">Singularity</a> 1.0+.

h2. License

Major components:

* "Modernizr":http://modernizr.com - MIT/BSD
* "Selectivizr":http://selectivizr.com - MIT
* "TinyNav":http://tinynav.viljamis.com - MIT
* "Hive Iconset":https://github.com/philwareham/hive-icons - MIT
